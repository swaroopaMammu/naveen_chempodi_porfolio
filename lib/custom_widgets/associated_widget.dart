...
class AssociatedWidget extends StatefulWidget {
  ...
  final void Function(AssociatedWork film) onTrailerTap;
  const AssociatedWidget({
    super.key,
    required this.films,
  ...
  @override
  State<AssociatedWidget> createState() => _AssociatedWidgetState();
}
...
class _AssociatedWidgetItem extends StatefulWidget {
  final AssociatedWork film;
  final VoidCallback onTap;

  const _AssociatedWidgetItem({
    required this.film,
    required this.onTap,
  });

  @override
  State<_AssociatedWidgetItem> createState() => _AssociatedWidgetItemState();
}

class _AssociatedWidgetItemState extends State<_AssociatedWidgetItem> {
